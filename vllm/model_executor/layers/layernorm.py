...
from vllm.model_executor.layers.kernels.rms_norm import choose_rms_norm_kernel
...
class RMSNorm(CustomOp):
    ...
    def __init__(
        ...
        self.rms_kernel = choose_rms_norm_kernel(weight_dtype=weight_dtype)

    def forward(self, x: torch.Tensor, residual: torch.Tensor | None = None):
        layer = self
        return self.rms_kernel.apply(layer, x, residual)
