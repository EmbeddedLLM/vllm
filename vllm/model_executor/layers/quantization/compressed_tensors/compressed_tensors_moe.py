...
__all__ = [
    ...
    "CompressedTensorsW8A8Fp8MoETritonMethod"
]
    ...
    def get_moe_method(
        ...
        if quant_config._is_wNa16_group_channel(weight_quant, input_quant):
            ...
            return CompressedTensorsW8A8Fp8MoECutlassMethod(quant_config)
              ...
              and layer.activation == "silu" and layer.expert_map is None):
            return CompressedTensorsW8A8Fp8MoETritonMethod(quant_config)
        elif quant_config._is_fp8_w8a8(weight_quant, input_quant):
...
# TODO: TO be merged with CompressedTensorsW8A8Fp8MoEMethod
class CompressedTensorsW8A8Fp8MoETritonMethod(CompressedTensorsMoEMethod):
