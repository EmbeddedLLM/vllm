...
from vllm.utils import direct_register_custom_op, rocm_aiter_fp8_block_scaled_moe_enabled
...
def apply_w8a8_block_fp8_linear(
    ...
    if cutlass_block_fp8_supported and shape_supported_by_cutlass:
        ...
        if rocm_aiter_fp8_block_scaled_moe_enabled():
            ...
            output = rocm_aiter.gemm_a8w8_blockscale(q_input, weight, x_scale, weight_scale, output)
        else:
