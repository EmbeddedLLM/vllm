...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_USE_AITER_TRITON_FUSED_QKV_ROPE: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to use aiter triton fused qkv rope op.
    # By default is disabled.
    "VLLM_ROCM_USE_AITER_TRITON_FUSED_QKV_ROPE":
    lambda: (os.getenv("VLLM_ROCM_USE_AITER_TRITON_FUSED_QKV_ROPE", "False")
             .lower() in ("true", "1")),
