...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_WHEEL_URL: str | None = None
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Optional URL to a ROCm wheel for precompiled builds (for development/testing)
    "VLLM_ROCM_WHEEL_URL": lambda: os.getenv("VLLM_ROCM_WHEEL_URL", None),
