...
if TYPE_CHECKING:
    ...
    VLLM_ROCM_DSV4_USE_AITER_HC_HEAD: bool = False
    VLLM_ROCM_DSV4_USE_AITER_MHC: bool = False
    VLLM_ROCM_DSV4_ATOM_ATTENTION: bool = False
    VLLM_ROCM_DSV4_ATOM_ATTENTION_LAYERS: str = ""
    VLLM_ROCM_DSV4_ATOM_ATTENTION_RATIOS: str = ""
    VLLM_ROCM_DSV4_ATOM_COMPRESS_FIRST: bool = False
    VLLM_ROCM_DSV4_ATOM_COMPRESS_PLAN: bool = False
    VLLM_ROCM_DSV4_ATOM_DEBUG_COMPRESS_FIRST: bool = False
    VLLM_ROCM_DSV4_ATOM_DECODE_INDEX_REUSE: bool = True
    VLLM_ROCM_DSV4_ATOM_DECODE_HCA_INDEX_REUSE: bool = True
    VLLM_ROCM_DSV4_ATOM_DECODE_KV_SPLITS: int = 0
    VLLM_ROCM_DSV4_ATOM_DECODE_SPLIT_WORKSPACE: str = "torch_empty"
    VLLM_ROCM_DSV4_ATOM_DISABLE_SWA_WRITE: bool = False
    VLLM_ROCM_DSV4_ATOM_FUSE_CSA_TRANSLATE_DECODE: bool = False
    VLLM_ROCM_DSV4_ATOM_FUSED_HCA_INDEX: bool = False
    VLLM_ROCM_DSV4_ATOM_HCA_CLAMP_INDICES: bool = False
    VLLM_ROCM_DSV4_ATOM_HCA_FLAT_CACHE: bool = False
    VLLM_ROCM_DSV4_ATOM_HCA_FORCE_SWA_ONLY: bool = False
    VLLM_ROCM_DSV4_ATOM_HCA_NATIVE_INDICES: bool = False
    VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_FREQ: int = 0
    VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_PATTERN: str = ""
    VLLM_ROCM_DSV4_ATOM_INDEXER_COMPRESSOR: bool = False
    VLLM_ROCM_DSV4_ATOM_INDEXER_DISPATCH: bool = False
    VLLM_ROCM_DSV4_ATOM_INDEXER_FASTPATH: bool = False
    VLLM_ROCM_DSV4_ATOM_INDEXER_SEQUENCE: bool = False
    VLLM_ROCM_DSV4_ATOM_SEPARATE_INVERSE_ROPE: bool = False
    VLLM_ROCM_DSV4_ATOM_MAIN_COMPRESSOR: bool = False
    VLLM_ROCM_DSV4_ATOM_MIXED_KV: bool = False
    VLLM_ROCM_DSV4_ATOM_MIXED_KV_FP8_MAX: float = 448.0
    VLLM_ROCM_DSV4_ATOM_NATIVE_AFTER_MAIN_COMPRESSOR: bool = False
    VLLM_ROCM_DSV4_REQUIRE_NATIVE_ATOM_ABI: bool = False
    VLLM_ROCM_DSV4_ATOM_PREFILL_ALLOW_MIXED: bool = False
    VLLM_ROCM_DSV4_ATOM_PREFILL_INDEX_REUSE: bool = True
    VLLM_ROCM_DSV4_ATOM_PREFILL_SYNC: bool = False
    VLLM_ROCM_DSV4_ATOM_PREFILL_SYNC_KIND: str = "device"
    VLLM_ROCM_DSV4_ATOM_PREFILL_SYNC_STAGES: str = ""
    VLLM_ROCM_DSV4_ATOM_PROBE_INDICES_ONLY: bool = False
    VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR: bool = False
    VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_EVERY: int = 128
    VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_LAYER: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_START_AFTER: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_DECODE: bool = False
    VLLM_ROCM_DSV4_ATOM_PROFILE_EVERY: int = 200
    VLLM_ROCM_DSV4_ATOM_PROFILE_LAYER: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA: bool = False
    VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_EVERY: int = 128
    VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_START_AFTER: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL: bool = False
    VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_T: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_TOKEN_OFFSET: int = 0
    VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_TRACE: bool = False
    VLLM_ROCM_DSV4_ATOM_RETURN_FALSE_AT_ENTRY: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESS_STATE_UPDATE: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESSOR_METADATA: bool = True
    VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_INDEX_WRITE: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_METADATA: bool = True
    VLLM_ROCM_DSV4_ATOM_SKIP_FUSED_COMPRESS: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_INDEXER_METADATA: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_DECODE: bool = False
    VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_PREFILL: bool = False
    VLLM_ROCM_DSV4_ATOM_SPLIT_KV_DECODE: bool = False
    VLLM_ROCM_DSV4_ATOM_STATE: bool = False
    VLLM_ROCM_DSV4_ATOM_STATE_ALLOC: bool = False
    VLLM_ROCM_DSV4_ATOM_UNIFIED_KV: bool = False
    VLLM_ROCM_DSV4_ATOM_UNIFIED_KV_FROM_VLLM: bool = False
    VLLM_ROCM_DSV4_ATOM_USE_INDEX_CACHE: bool = False
    VLLM_ROCM_DSV4_ATOM_VARIABLE_STATE_UPDATE: bool = False
...
def env_int(env_name: str, default: int = 0) -> Callable[[], int]:
    def _get_env_int() -> int:
        value = os.getenv(env_name)
        if value is None or value == "":
            value = str(default)
        return int(value)
...
def env_float(env_name: str, default: float = 0.0) -> Callable[[], float]:
    def _get_env_float() -> float:
        value = os.getenv(env_name)
        if value is None or value == "":
            value = str(default)
        return float(value)
...
def env_str(env_name: str, default: str = "") -> Callable[[], str]:
    return lambda: os.getenv(env_name, default)
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_ROCM_DSV4_ATOM_ATTENTION_LAYERS": env_str(
        "VLLM_ROCM_DSV4_ATOM_ATTENTION_LAYERS"
    ),
    "VLLM_ROCM_DSV4_ATOM_ATTENTION_RATIOS": env_str(
        "VLLM_ROCM_DSV4_ATOM_ATTENTION_RATIOS"
    ),
    ...
    "VLLM_ROCM_DSV4_ATOM_DECODE_INDEX_REUSE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_DECODE_INDEX_REUSE", True
    ),
    "VLLM_ROCM_DSV4_ATOM_DECODE_HCA_INDEX_REUSE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_DECODE_HCA_INDEX_REUSE", True
    ),
    "VLLM_ROCM_DSV4_ATOM_DECODE_KV_SPLITS": env_int(
        "VLLM_ROCM_DSV4_ATOM_DECODE_KV_SPLITS"
    ),
    "VLLM_ROCM_DSV4_ATOM_DECODE_SPLIT_WORKSPACE": env_str(
        "VLLM_ROCM_DSV4_ATOM_DECODE_SPLIT_WORKSPACE", "torch_empty"
    ),
    "VLLM_ROCM_DSV4_ATOM_DISABLE_SWA_WRITE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_DISABLE_SWA_WRITE"
    ),
    "VLLM_ROCM_DSV4_ATOM_FUSE_CSA_TRANSLATE_DECODE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_FUSE_CSA_TRANSLATE_DECODE"
    ),
    "VLLM_ROCM_DSV4_ATOM_FUSED_HCA_INDEX": env_bool(
        "VLLM_ROCM_DSV4_ATOM_FUSED_HCA_INDEX"
    ),
    "VLLM_ROCM_DSV4_ATOM_HCA_CLAMP_INDICES": env_bool(
        "VLLM_ROCM_DSV4_ATOM_HCA_CLAMP_INDICES"
    ),
    "VLLM_ROCM_DSV4_ATOM_HCA_FLAT_CACHE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_HCA_FLAT_CACHE"
    ),
    "VLLM_ROCM_DSV4_ATOM_HCA_FORCE_SWA_ONLY": env_bool(
        "VLLM_ROCM_DSV4_ATOM_HCA_FORCE_SWA_ONLY"
    ),
    "VLLM_ROCM_DSV4_ATOM_HCA_NATIVE_INDICES": env_bool(
        "VLLM_ROCM_DSV4_ATOM_HCA_NATIVE_INDICES"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_FREQ": env_int(
        "VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_FREQ"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_PATTERN": env_str(
        "VLLM_ROCM_DSV4_ATOM_INDEX_TOPK_PATTERN"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEXER_COMPRESSOR": env_bool(
        "VLLM_ROCM_DSV4_ATOM_INDEXER_COMPRESSOR"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEXER_DISPATCH": env_bool(
        "VLLM_ROCM_DSV4_ATOM_INDEXER_DISPATCH"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEXER_FASTPATH": env_bool(
        "VLLM_ROCM_DSV4_ATOM_INDEXER_FASTPATH"
    ),
    "VLLM_ROCM_DSV4_ATOM_INDEXER_SEQUENCE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_INDEXER_SEQUENCE"
    ),
    "VLLM_ROCM_DSV4_ATOM_SEPARATE_INVERSE_ROPE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SEPARATE_INVERSE_ROPE"
    ),
    "VLLM_ROCM_DSV4_ATOM_MAIN_COMPRESSOR": env_bool(
        "VLLM_ROCM_DSV4_ATOM_MAIN_COMPRESSOR"
    ),
    "VLLM_ROCM_DSV4_ATOM_MIXED_KV": env_bool("VLLM_ROCM_DSV4_ATOM_MIXED_KV"),
    "VLLM_ROCM_DSV4_ATOM_MIXED_KV_FP8_MAX": env_float(
        "VLLM_ROCM_DSV4_ATOM_MIXED_KV_FP8_MAX", 224.0
    ),
    "VLLM_ROCM_DSV4_ATOM_NATIVE_AFTER_MAIN_COMPRESSOR": env_bool(
        "VLLM_ROCM_DSV4_ATOM_NATIVE_AFTER_MAIN_COMPRESSOR"
    ),
    "VLLM_ROCM_DSV4_REQUIRE_NATIVE_ATOM_ABI": env_bool(
        "VLLM_ROCM_DSV4_REQUIRE_NATIVE_ATOM_ABI"
    ),
    "VLLM_ROCM_DSV4_ATOM_PREFILL_ALLOW_MIXED": env_bool(
        "VLLM_ROCM_DSV4_ATOM_PREFILL_ALLOW_MIXED"
    ),
    ...
    "VLLM_ROCM_DSV4_ATOM_PREFILL_SYNC_STAGES": env_str(
        "VLLM_ROCM_DSV4_ATOM_PREFILL_SYNC_STAGES"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROBE_INDICES_ONLY": env_bool(
        "VLLM_ROCM_DSV4_ATOM_PROBE_INDICES_ONLY"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR": env_bool(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_EVERY": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_EVERY", 200
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_LAYER": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_LAYER"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_START_AFTER": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_COMPRESSOR_START_AFTER"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_DECODE": env_bool(
    ...
    "VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_EVERY": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_EVERY", 128
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_START_AFTER": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_METADATA_START_AFTER"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL": env_bool(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_T": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_T"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_TOKEN_OFFSET": env_int(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_MIN_TOKEN_OFFSET"
    ),
    "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_TRACE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_PROFILE_PREFILL_TRACE"
    ),
    "VLLM_ROCM_DSV4_ATOM_RETURN_FALSE_AT_ENTRY": env_bool(
        "VLLM_ROCM_DSV4_ATOM_RETURN_FALSE_AT_ENTRY"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESS_STATE_UPDATE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESS_STATE_UPDATE"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESSOR_METADATA": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_COMPRESSOR_METADATA", True
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_INDEX_WRITE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_INDEX_WRITE"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_METADATA": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_DECODE_METADATA", True
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_FUSED_COMPRESS": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_FUSED_COMPRESS"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_INDEXER_METADATA": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_INDEXER_METADATA"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_DECODE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_DECODE"
    ),
    "VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_PREFILL": env_bool(
        "VLLM_ROCM_DSV4_ATOM_SKIP_PAGED_PREFILL"
    ),
    "VLLM_ROCM_DSV4_ATOM_SPLIT_KV_DECODE": env_bool(
    ...
    "VLLM_ROCM_DSV4_ATOM_USE_INDEX_CACHE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_USE_INDEX_CACHE"
    ),
    "VLLM_ROCM_DSV4_ATOM_VARIABLE_STATE_UPDATE": env_bool(
        "VLLM_ROCM_DSV4_ATOM_VARIABLE_STATE_UPDATE"
    ),
